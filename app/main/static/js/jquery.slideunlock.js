...
function SliderUnlock(elm, options, success, always) {
    ...
    var opts = {
        labelTip: typeof(options.labelTip)!=="undefined" ? options.labelTip : "慢慢滑动游标到右侧",
        successLabelTip: typeof(options.successLabelTip)!=='undefined' ? options.successLabelTip : "成功!",
